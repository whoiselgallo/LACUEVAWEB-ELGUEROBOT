...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        if (!$yt) {
            $yt = [
                'plataforma' => 'youtube',
                'titulo'     => 'Último Episodio Completo - La Cueva del Güero',
                'embed_id'   => 'ScMzIvxBSi4', // ID de respaldo de video completo
            ];
        }
        ...
        if (!$sp) {
            $sp = [
                ...
                'embed_id'    => '4kIy0j2',
                'portada_url' => 'https://img.youtube.com/vi/ScMzIvxBSi4/maxresdefault.jpg',
